...
export default function CodeSandbox({ lesson2 = false }) {
  ...
  return <section id={lesson2 ? 'playground' : 'sandbox'} className="section-shell playground-section react-learning-section">
    <div className="section-heading"><span>ลงมือทำ · Live Code Sandbox</span><h2>{lesson2 ? 'แก้โค้ด แล้วดูผลลัพธ์ทันที' : 'ทดลองเขียนโครงสร้าง HTML5'}</h2><p>{lesson2 ? 'ลองเปลี่ยนระดับหัวข้อ เพิ่มย่อหน้า หรือวางเส้นคั่นระหว่างเนื้อหา' : 'แก้ไขโค้ด แล้วกดรันเพื่อดูผลลัพธ์ในเบราว์เซอร์จำลอง'}</p></div>
